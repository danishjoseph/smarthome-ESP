...
const char* mqtt_server = "0.0.0.0";  // mosquitto broker IP
const char* roomName = "bedroom";   // esp name
int mqttPort = 1883; // mqtt port default is 1883
String device[DEVICELENGTH] = {"b11","b12","b13","b14"}; // change the device name to your liking but device id must be unique !!
int relays[DEVICELENGTH] = { 10,13,12,14 };                        // GPIO pins to be connected in the relay
int switches[DEVICELENGTH] =  {4,1,3,5};                           // GPIO pins to be connected in the switch
...
pinMode(3, FUNCTION_3);
  ...
  ArduinoOTA.setHostname(roomName);
  ArduinoOTA.begin();
